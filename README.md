...
> use o comando `cd backend` ou `cd frontend` para navegar para a pasta correspondente

### Rodando o projeto
# para levantar o servidor, execute o comando `npm run start` ou `npm run dev`
> Nodemon: `npm run dev` é para rodar o servidor em modo desenvolvimento, junto com o nodemon
...
# veja o arquivo `env.example` para ver os campos que devem ser preenchidos
